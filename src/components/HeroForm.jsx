        ...
        <div className="space-y-5 animate-in fade-in slide-in-from-left-12 duration-1000">
          ...
          <div className="pt-2">
            <div className="flex flex-wrap justify-center lg:justify-start items-center gap-4">
              ...
              <Button  
                variant="outline"
                className="px-8 md:px-10 py-4 border-2 border-slate-900/10 dark:border-white/20 text-slate-950 dark:text-white font-black hover:bg-slate-100 dark:hover:bg-white/10 shadow-sm text-[10px] md:text-xs tracking-widest uppercase transition-all"
