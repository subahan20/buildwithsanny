      ...
      <div className="max-w-4xl mx-auto px-8 flex flex-col md:flex-row gap-16 items-center relative z-10 animate-in fade-in duration-1000">
        ...
        <div className="flex-1 space-y-8 text-left">
          <div className="space-y-4">
            <span className="text-yellow-600 font-black uppercase tracking-[0.3em] text-[10px] bg-yellow-50 border border-yellow-100 px-3 py-1 rounded-full">About Me</span>
