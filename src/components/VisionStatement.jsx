    ...
    <section className="py-4 px-4 md:px-8 bg-bg relative overflow-hidden transition-all duration-500">
      <div className="max-w-[1440px] mx-auto relative z-10 flex justify-center text-center">
        <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-12 duration-1000">
          ...
          {/* Main Headline */}
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter leading-none mb-10 text-text transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left mb-10">
            <p className="text-text/60 text-base sm:text-lg md:text-xl font-bold leading-relaxed transition-colors">
